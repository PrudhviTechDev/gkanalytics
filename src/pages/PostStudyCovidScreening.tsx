...
export const PostStudyCovidScreening = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    periodNo: 'Post Study',
    subjectNo: '',
    screeningType: 'Post study safety',
    otherScreeningType: '',
    temperature: '',
    temperatureStatus: '',
    historyItems: [
        ...
        <div className="space-y-2">
          <div className="flex gap-4 items-center">
            <label className="inline-flex items-center">
              <input
                type="checkbox"
                checked={formData.screeningType === 'Post study safety'}
                onChange={() => updateForm('screeningType', 'Post study safety')}
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-4">
            <div className="flex-1">
              <label className="block text-sm font-medium text-gray-700">Temperature recorded by IR Thermometer is</label>
