...
export const PostStudyDepressionScale = () => {
  const { volunteerId } = useVolunteer();
  const [formData, setFormData] = useState({
    studyNo: '079-24',
    crbVersion: '02',
    date: '',
    studyPeriod: 'Post Study',
    checkType: 'post-study',
    depressionItems: [
      {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
      <div className="border-b pb-4 mb-6">
        ...
        <div className="mt-4">
          <h2 className="text-xl font-bold text-center">Annexure – 4 Post Study Depression Scale</h2>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="border-t pt-4 space-y-4">
          ...
          />
          <div className="text-sm text-gray-500 text-center">(PI/CI/Physician)</div>
        </div>
      </div>
    </div>
  );
